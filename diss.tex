...
\footnotetext[1]{{counted with Overleaf's builtin feature using TeXCount}}
\stepcounter{footnote}
\footnotetext[2]{{counted with \texttt{git ls-files | xargs wc -l}. There are $6685$ lines in the source directory and $1185$ lines in the test directory. $582$ lines of source code written by external authors needed to be subtracted.}}
\stepcounter{footnote}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.55]{code-demo-osmnx.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.9]{camb-demo-osmnx.png}
